...
#SBATCH --job-name=t5_new_medium            # Job name
#SBATCH --output=logs/t5_new_medium.%A_%a.txt   # Standard output and error log
#SBATCH --nodes=1                   # Run all processes on a single node
#SBATCH --gres=gpu:4          # Number of GPUs (per node)
#SBATCH -p it-hpc                      # Use the it-dept partition
#SBATCH --time=12:00:00             # Specify the time needed for your experiment

export WANDB_NAME=t5-new-medium
...
SAVE_DIR=$OUTPUT_ROOT/sttatts/models_english_150K_t5_new_medium/
TRAIN_SET="train-100-360|train-100-360-500"
...
# removed batch and sample ratio
  # --batch-ratio "[0.5,0.5]" \ # SBATCH --qos nlp-pool 
