...
#SBATCH --job-name=t5_new            # Job name
#SBATCH --output=logs/t5_new.%A_%a.txt   # Standard output and error log
#SBATCH --nodes=1                   # Run all processes on a single node
#SBATCH --gres=gpu:2          # Number of GPUs (per node)
#SBATCH -p it-hpc                      # Use the it-dept partition
#SBATCH --time=12:00:00             # Specify the time needed for your experiment

export WANDB_NAME=t5-new-small
...
SAVE_DIR=$OUTPUT_ROOT/sttatts/models_english_150K_t5_new/
TRAIN_SET="train-clean-100|train-clean-360"
